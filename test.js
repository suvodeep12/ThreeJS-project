(function (app) {
  ...
  let metadata = {
    urls: {
      github:
        "https://github.com/bradyhouse/house/tree/master/fiddles/three/fiddle-0006-Saturn",
      saturn: {
        surfaceMaterial:
          "https://s3-us-west-2.amazonaws.com/s.cdpn.io/297733/saturnSurface.jpg",
        ringsMaterial:
  ...
  app.view.milkyway.Planet = class extends app.toolkit.three.Object {
    ...
    constructor(config) {
      ...
      this._type =
        config && config.hasOwnProperty("type")
          ? config.type
          : this.config().type;
  ...
  app.view.milkyway.saturn.Rings = class extends THREE.Geometry {
    ...
    constructor(config) {
      super();
      this._innerRadius =
        config && config.hasOwnProperty("innerRadius")
          ? config.innerRadius
          : this.config().innerRadius;
      this._outerRadius =
        config && config.hasOwnProperty("outerRadius")
          ? config.outerRadius
          : this.config().outerRadius;
      this._gridY =
        config && config.hasOwnProperty("gridY")
          ? config.gridY
          : this.config().gridY;
      this._autoInit =
  ...
  app.view.milkyway.saturn.Saturn = class extends app.view.milkyway.Planet {
    ...
    createRings() {
      ...
      ringsMesh.rotation.y = 0.09;
      this.planetGroup.add(ringsMesh);
      this.planetGroup.position.x = -0.2;
